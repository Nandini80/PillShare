  ...
  const handleSubmit = async (e) => {
    ...
    if (authMode === "register") {
      ...
      if (data.token) {
        ...
        navigate(
          data.role === "donor" ? "/donor-dashboard" : "/needy-dashboard"
        );
      } else {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Connect medicine donors with those in need. A platform that brings
              communities together to ensure no one goes without essential
              medication.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              PillShare is a revolutionary platform that bridges the gap between
              medicine surplus and shortage, creating a community-driven
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600">
                To ensure that no one goes without essential medication by
                connecting generous donors with those in need within local
                communities.
              </p>
            </div>
            ...
            <div className="text-center p-6 rounded-xl bg-gradient-to-br from-green-50 to-green-100 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600">
                We believe in the power of community support. Every donation and
                request is handled with care, dignity, and respect.
              </p>
            </div>
            ...
            <div className="text-center p-6 rounded-xl bg-gradient-to-br from-purple-50 to-purple-100 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600">
                All transactions are verified and secure. We ensure prescription
                validation and proper medicine handling protocols.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Simple, secure, and effective. Connect with your community in just
              a few steps.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Sign up as a donor and complete your profile with contact
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Add details about medicines you want to donate including
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Get connected with people in need and arrange safe
                      medicine transfers.
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Create your account and provide necessary details for
                      verification.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Enter your location and required medicine with doctor's
                      prescription.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      View nearby donors and connect with them to arrange
                      medicine collection.
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-xl hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600">
                Find donors and recipients in your immediate area for quick and
                easy medicine transfers.
              </p>
            </div>
            ...
            <div className="text-center p-6 rounded-xl hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600">
                Automatic alerts for expiring medicines to ensure only safe
                medications are shared.
              </p>
            </div>
            ...
            <div className="text-center p-6 rounded-xl hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600">
                All medicine requests are verified with proper medical
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of people who are already making healthcare more
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 mb-4 max-w-md">
                Connecting communities through medicine sharing. Making
                healthcare accessible to everyone, one donation at a time.
              </p>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p className="text-gray-400">
              © 2025 PillShare. All rights reserved. Made with ❤️ for a
              healthier community.
            </p>
          </div>
        </div>
